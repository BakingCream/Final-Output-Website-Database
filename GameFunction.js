...
function start(){
	...
	let gameoverscreen, gameStopped, gameSpeed, savescreen
	gameoverscreen = document.querySelector( '#gameoverscreen' )
	savescreen = document.querySelector( '#savescorescreen' )
	...
	function showGameoverscreen() {
		...
		window.removeEventListener("mousedown", aim);
		window.removeEventListener("mousedown", loose);
		gameoverscreen.style.display = ''
		document.getElementById("title").innerHTML = "Your Score<br>" + Addscore;
		document.getElementById("playbutton").innerHTML = "Retry";
	}

	function showSavescreen() {
		savescreen.style.display = ''
		window.removeEventListener("mousedown", start);
		window.removeEventListener("mousedown", draw);
		window.removeEventListener("mousedown", aim);
		window.removeEventListener("mousedown", loose);
		gameoverscreen.style.display = 'none'
		document.getElementById("savetitle").innerHTML = "Your Score<br>" + Addscore;
	}
	...
	gameoverscreen.querySelector( '#save' ).addEventListener( 'click', _ => {
		showSavescreen()
		gameStopped = false
   })
	...
	countTimeOut = setTimeout(gameOver, 5500);
    }
	countTime();
